        ...
        match self.currPhase:
            case 0:
                ...
                if len(self.positionSaver) >= 3 and not isPhaseSwitch:   
                    ...
                    turnAngle = calculate_turn_angle(prevPrevPos, prevPos, self.currPos)
            ...
            case 2:
                ...
                if deltaToStart < 0:
                    ...
                    shaping_reward -= cap_late_stage_penalty(
                        self,
                        away_penalty,
                ...
                curr_final_area = calculate_triangle_area(self.startPos, self.corner1, self.corner2)
                if self.curriculum_stage < 3:
                    shaping_reward += 0.2 * curr_final_area
                shaping_reward += self.reward_Phase2AreaPreservation * curr_final_area

                alignment = get_return_direction_alignment(self, prevPos, self.currPos)
                ...
                segment_points = get_segment_points(self, segment_start_idx, len(self.positionSaver) - 1)
                deviation = segment_mean_deviation(self.corner2, self.startPos, segment_points)
